...
pub struct ArrayIndex<const EMIT_ERRS: bool, Stream>
where
    Stream: JQStream,
{
    finished: bool,
...
impl<const EMIT_ERRS: bool, Stream> ArrayIndex<EMIT_ERRS, Stream>
where
    Stream: JQStream,
{
    pub(crate) fn new(stream: Stream, index: isize) -> Self {
        Self {
            finished: false,
...
impl<const EMIT_ERRS: bool, Stream> Iterator for ArrayIndex<EMIT_ERRS, Stream>
where
    Stream: JQStream,
{
...
impl<const EMIT_ERRS: bool, Stream> SanitizedJQStream for ArrayIndex<EMIT_ERRS, Stream> where
    Stream: JQStream
{
}
